...
export default function Footer() {
    return (
        <footer className="bg-gray-900 text-white pt-12 pb-6 md:px-10">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                    ...
                    {/* Quick Links */}
                    <div className="col-span-1 md:pl-12 lg:pl-24">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/products">
                                    <span className="text-gray-400 hover:text-white transition">Products</span>
                                </Link>
                            </li>
                            <li>
                                <Link href="/about">
                                    <span className="text-gray-400 hover:text-white transition">About</span>
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="space-y-3 text-gray-400">
                            <p className="flex items-start">
                                <svg
                                    className="h-5 w-5 mr-2 mt-0.5 text-green-400"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                ...
                <div className="border-t border-gray-800 pt-6 mt-6">
                    <p className="text-center text-gray-500 text-sm">
                        &copy; {new Date().getFullYear()} Verdūre. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
